    ...
    return (
        <StyledTermsAndConditions>
            ...
            <section className="terms-and-conditions">
                ...
                <ul>
                    ...
                    <li>
                        <p>
                            ...
                            Agreement) refers to ATL Photography LTD, Apartment 9 Woodthorpe Mews Woodthorpe Drive
                            Nottingham NG5 4AT.
                        </p>
                    </li>
                    <li>
                    ...
                    <li>
                        <p>
                            <strong>Website</strong> refers to ATL Photography, accessible from{' '}
                            <a href="www.atlphotography.co.uk" rel="external nofollow noopener" target="_blank">
                                www.atlphotography.co.uk
                            </a>
                        </p>
                    </li>
                    <li>
                ...
                <ul>
                    <li>By email: lekawa.tomasz@gmail.com</li>
                </ul>
            </section>
        </StyledTermsAndConditions>
    );
