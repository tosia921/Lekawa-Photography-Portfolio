    ...
    return (
        <StyledPrivacyPolicy>
            ...
            <div className="policy-container">
                <h1>Privacy Policy for ATL Photography LTD</h1>

                <p>
                    At ATL Photography, accessible from www.atlphotography.co.uk, one of our main priorities is the
                    privacy of our visitors. This Privacy Policy document contains types of information that is
                    collected and recorded by ATL Photography and how we use it.
                </p>
                ...
                <p>
                    ...
                    with regards to the information that they shared and/or collect in ATL Photography. This policy is
                ...
                <p>
                    ATL Photography follows a standard procedure of using log files. These files log visitors when they
                ...
                <p>
                    Like any other website, ATL Photography uses 'cookies'. These cookies are used to store information
                ...
                <p>
                    You may consult this list to find the Privacy Policy for each of the advertising partners of ATL
                    Photography.
                </p>

                <p>
                    Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons
                    that are used in their respective advertisements and links that appear on ATL Photography, which are
                ...
                <p>
                    Note that ATL Photography has no access to or control over these cookies that are used by
                ...
                <p>
                    ATL Photography's Privacy Policy does not apply to other advertisers or websites. Thus, we are
                ...
                <p>
                    ATL Photography does not knowingly collect any Personal Identifiable Information from children under
